    ...
    <ProtectedRoute>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 animate-fade-in">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-bold font-heading text-white">Create New Story</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className={`
              ...
              {preview ? (
                ...
                <div className="text-center text-slate-400">
                  ...
                  <p className="text-sm text-slate-500 mt-1">Recommended size: 1200x630px</p>
                </div>
              )}
          ...
          <div className="flex justify-end pt-4">
            <Button type="submit" loading={loading} size="lg" className="px-8">
              <FiSave className="mr-2" /> Publish Story
            </Button>
          </div>
        </form>
      </div>
